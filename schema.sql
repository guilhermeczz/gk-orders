...
\restrict oG8b6MyUqjg2IByXxWuuPRIDwOqNhHyHstYLNIcGa1t4ehK1tlfoHhiIc8FDrlK
...
CREATE TABLE public.cash_closings (
    ...
    reported_total numeric(10,2) NOT NULL,
...
CREATE TABLE public.pedido_itens (
    ...
    batch_notes text,
    batch_created_at timestamp with time zone DEFAULT now()
);
...
--
-- Name: idx_cash_sessions_closed_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cash_sessions_closed_at ON public.cash_sessions USING btree (closed_at);
...
--
-- Name: idx_pedido_itens_pedido_batch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pedido_itens_pedido_batch ON public.pedido_itens USING btree (pedido_id, batch_number);


--
-- Name: idx_pedidos_cash_session_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pedidos_cash_session_id ON public.pedidos USING btree (cash_session_id);
...
--
-- Name: pedidos pedidos_cash_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pedidos
    ADD CONSTRAINT pedidos_cash_session_id_fkey FOREIGN KEY (cash_session_id) REFERENCES public.cash_sessions(id) ON DELETE SET NULL;
...
--
-- Name: cash_closings Acesso_Total_Autenticado; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Acesso_Total_Autenticado" ON public.cash_closings TO authenticated USING (true) WITH CHECK (true);


--
-- Name: cash_closings Insercao apenas para usuarios autenticados; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Insercao apenas para usuarios autenticados" ON public.cash_closings FOR INSERT WITH CHECK ((auth.role() = 'authenticated'::text));


--
-- Name: cash_closings Leitura apenas para usuarios autenticados; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Leitura apenas para usuarios autenticados" ON public.cash_closings FOR SELECT USING ((auth.role() = 'authenticated'::text));


--
-- Name: cash_closings; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: cash_sessions cash_sessions_insert_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY cash_sessions_insert_authenticated ON public.cash_sessions FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: cash_sessions cash_sessions_select_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY cash_sessions_select_authenticated ON public.cash_sessions FOR SELECT TO authenticated USING (true);


--
-- Name: cash_sessions cash_sessions_update_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY cash_sessions_update_authenticated ON public.cash_sessions FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: pedido_itens pedido_itens_delete_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pedido_itens_delete_authenticated ON public.pedido_itens FOR DELETE TO authenticated USING (true);


--
-- Name: pedido_itens pedido_itens_insert_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pedido_itens_insert_authenticated ON public.pedido_itens FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: pedido_itens pedido_itens_select_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: pedido_itens pedido_itens_update_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: pedidos pedidos_delete_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pedidos_delete_authenticated ON public.pedidos FOR DELETE TO authenticated USING (true);


--
-- Name: pedidos pedidos_insert_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pedidos_insert_authenticated ON public.pedidos FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: pedidos pedidos_select_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: pedidos pedidos_update_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime pedido_itens; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.pedido_itens;


--
-- Name: supabase_realtime pedidos; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE cash_closings; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE cash_sessions_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.cash_sessions_id_seq TO anon;
GRANT ALL ON SEQUENCE public.cash_sessions_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.cash_sessions_id_seq TO service_role;
...
--
-- Name: SEQUENCE pedido_itens_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.pedido_itens_id_seq TO anon;
GRANT ALL ON SEQUENCE public.pedido_itens_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.pedido_itens_id_seq TO service_role;
...
--
-- Name: SEQUENCE pedidos_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE messages_2026_04_22; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_04_23; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_04_24; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_04_25; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_04_26; Type: ACL; Schema: realtime; Owner: -
--
...
\unrestrict oG8b6MyUqjg2IByXxWuuPRIDwOqNhHyHstYLNIcGa1t4ehK1tlfoHhiIc8FDrlK
